...
class Player:
    def __init__(self):
        ...
        self.state_machine.set_transitions(
            {
                Walk: {right_down: Idle, left_down: Idle, right_up: Idle, left_up: Idle, q_down: Aura,  w_down: Brds, dead: Dead},
                Idle: {right_down: Walk, left_down: Walk, q_down: Aura,  w_down: Brds, dead: Dead},
                Aura: {time_out: Wait, dead: Dead},
                Brds: {time_out: Wait, dead: Dead},
                Wait: {right_down: Walk, left_down: Walk, q_down: Aura,  w_down: Brds, dead: Dead},
                Dead: {revive: Idle}
            }
        )
    def draw(self):
